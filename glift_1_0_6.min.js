...
glift.widgets.options.baseOptions={sgf:void 0,sgfDefaults:{sgfString:void 0,url:void 0,alias:void 0,parseType:glift.parse.parseType.SGF,widgetType:glift.enums.widgetTypes.GAME_VIEWER,initialPosition:"",nextMovesPath:"",boardRegion:glift.enums.boardRegions.AUTO,rotation:glift.enums.rotations.NO_ROTATION,problemConditions:{GB:[],C:["Correct","is correct","is the correct","Correto","correto"]},keyMappings:{ARROW_LEFT:"iconActions.chevron-left.click",ARROW_RIGHT:"iconActions.chevron-right.click"},uiComponents:["BOARD","COMMENT_BOX",
